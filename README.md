...
| 상품 등록 | Product Create | 손님에게 판매할 상품을 등록한다.         |
| 가격 변경 | Price Change | 상품의 가격을 변경한다.              |

### 메뉴 그룹
| 한글명      | 영문명              | 설명          |
|----------|------------------|-------------|
| 메뉴 그룹    | Menu Group       | 여러 메뉴의 묶음   |
| 메뉴 그룹 등록 | MenuGroup Create | 메뉴그룹을 등록한다. |
...
| 메뉴 등록    | Menu Create  | 메뉴를 등록한다.              |
| 가격 변경    | Price Change | 메뉴의 가격을 변경한다.          |
| 메뉴 노출    | display      | 메뉴를 노출시킨다.             |
| 메뉴 숨기기   | hide         | 메뉴를 숨긴다.               |
...
| 주문 테이블 생성 | Table Create            | 새로운 주문테이블을 생성한다.      |
| 손님 착석     | sit                     | 손님에게 테이블을 안내하고 착석시킨다. |
| 테이블 정리    | clear                   | 테이블을 정리한다.            |
| 손님 수 변경   | Number Of Guests Change | 테이블에 앉은 손님 수를 변경한다.   |
...
| 주문 생성 | Order Create   | 새로운 주문을 생성한다.  |
