...
| 배달 주문       | Delivery Order             | 상품을 주소지로 배달 하는 주문 이다.     (접수대기>접수>서빙>배달중>배달완료>완료) |
| 포장 주문       | Takeout Order              | 상품을 매장에서 가져가는 주문 이다.  (접수대기>접수>서빙>완료)              |
| 매장 주문       | Eat-in Order               | 상품을 매장에서 테이블에 앉아서 먹고 가는 주문이다.(접수대기>접수>서빙>완료)       |
...
| 주문 배달       | Start Delivery of Order    | 배달 주문의 경우에만, 제공 된 주문을 배달 할 수 있다.                   |
