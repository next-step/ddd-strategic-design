...
| 주문 | Order       | 손님들이 메뉴를 구매하고자 하는 내역을 의미한다.                       |
...
| 한글명 | 영문명         | 설명                                       |
|--|-------------|------------------------------------------|
| 상품 등록 | Product Create    | 키친포스 시스템에 상품을 등록하는 것을 의미한다. |
...
| 한글명 | 영문명         | 설명                                                |
|--|-------------|---------------------------------------------------|
| 메뉴 등록 |  Menu Create   | 키친포스 시스템에 메뉴를 등록하는 것을 의미한다. |
| 가격 변경 |  Menu    | 키친포스 시스템에 메뉴를 등록하는 것을 의미한다. |
| 전시 | Display | 손님이 구매할 수 있는 상태 여부를 의미한다. |
| 숨겨진 메뉴 | Hidden Menu | 전시되지 않는 메뉴를 의미한다. |
| 메뉴 가격 변경 | Menu Price Change    | 메뉴의 가격을 변경하는 것을 의미한다. |
