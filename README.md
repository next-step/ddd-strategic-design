...
| 주문 타입 - 매장 내 식사 | EAT_IN | 매장 내 주문. 테이블에서 식사하는 주문이다. 손님이 앉아 있는 테이블에 주문이 가능하다. |
...
| 주문 상태 - 서빙 완료 | SERVED | 주문 타입이 포장 혹은 매장 내 식사인 경우 상품이 손님에게 전달 된 상태, 주문 타입이 배달인 경우 상품이 준비된 상태 |
| 주문 상태 - 배달중 | DELIVERING | 주문 타입이 배달인경우 배달이 출발한 상태 |
| 주문 상태 - 배달 완료 | DELIVERED | 주문 타입이 배달인경우 배달이 완료된 상태 |
