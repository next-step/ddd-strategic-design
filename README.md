...
| 한글명           | 영문명                                 | 설명                             |
|---------------|-------------------------------------|--------------------------------|
| 이름            | Name                                | 비즈니스 요소를 표현하기 위한 말             |
| 가격            | Price                               | 재화의 가치를 금액으로 표현한 것             |
| 비속어           | Profanity                           | 막말이 가미된 모욕적인 말 또는 모독적인 말       |
| 수량            | Quantity                            | 재화의 양적 단위                      |
| 생성            | Create                              | 비즈니스 요소를 새로 만드는 행위             |
| 변경            | Change                              | 비즈니스 요소의 속성을 바꾸는 행위            |
| 노출여부          | Displayed                           | 비즈니스 요소를 대상에게 보여주기 위한 기준       |
| 노출            | Display                             | 비즈니스 요소를 대상에게 보여주는 행위          |
| 숨김            | Hide                                | 비즈니스 요소를 대상에게 숨기는 행위           |
| 수             | Number                              | 비즈니스 요소를 세기 위한 단위              |
| 손님            | Guest                               | 매장을 이용하는 사람                    |
| 착석            | Sit                                 | 자리에 앉는 행위                      |
| 비움            | Clear                               | 대상에 채워진 요소를 없애는 행위             |
| 유형            | Type                                | 비즈니스 요소의 행위와 속성을 구분하기 위한 기준    |
| 상태            | Status                              | 비즈니스 요소의 생애주기를 구분하기 위한 기준      |
| 시각            | Date Time                           | 년, 월, 일, 시분초                   |
| 순번            | Sequence                            | 비즈니스 요소의 우선순위를 결정하기 위한 기준      |

### 상품
| 한글명           | 영문명                                 | 설명                             |
|---------------|-------------------------------------|--------------------------------|
| 상품            | Product                             | 판매를 위해 매장에서 제조하거나 보유한 음식 또는 물건 |
...
| 한글명           | 영문명                                 | 설명                             |
|---------------|-------------------------------------|--------------------------------|
| 메뉴 그룹         | Menu Group                          | 메뉴의 집합. 메뉴를 분류하기 위한 기준         |
| 메뉴 그룹명        | Menu Group Name                     | 메뉴그룹의 이름                       |
| 메뉴 그룹 생성      | Create Menu Group                   | 메뉴그룹을 새로 정의해 등록하는 행위           |

### 메뉴
| 한글명           | 영문명                                 | 설명                             |
|---------------|-------------------------------------|--------------------------------|
| 메뉴            | Menu                                | 고객이 상품을 선택하기 위한 단위             |
| 메뉴명           | Menu Name                           | 메뉴의 이름                         |
| 메뉴명           | Menu Price                          | 메뉴의 가격                         |
| 메뉴 가격 변경      | Change Menu Price                   | 메뉴의 가격을 변경하는 행위                |
| 메뉴 노출여부       | Menu Displayed                      | 메뉴의 노출여부                       |
...
| 한글명           | 영문명                                 | 설명                             |
|---------------|-------------------------------------|--------------------------------|
| 주문테이블         | Order Table                         | 매장에서 주문이 일어나는 테이블              |
| 주문테이블명        | Order Table Name                    | 주문 테이블의 이름                     |
