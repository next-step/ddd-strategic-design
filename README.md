...
| 한글명          | 영문명                   | 설명                            |
|--------------|-----------------------|-------------------------------|
| 상품           | Product               | 손님에게 파는 상품                    |
| 상품 가격        | Product Price         | 손님에게 파는 상품의 가격                |
| 상품 이름        | Product Name          | 손님에게 파는 상품의 이름으로 비속어를 포함하지 않음 |
| 상품 등록        | Product Registration  | 손님에게 판매를 하고자 하는 상품을 등록        |
