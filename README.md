...
| 한글명 | 영문명      | 설명      |
|-----|----------|-----------------------------|
| 비속어 | Bad Name | 부적절한 단어 또는 비속어 |
| 수량  | Quantity | 최소 0개 이상인 수량                |
| 가격  | Price    | 최소 0원 이상인 가격                |
...
| 한글명   | 영문명            | 설명                      |
|-------|----------------|-------------------------|
| 메뉴    | Menu           | 판매할 수 있는 최소 단위, 상품들의 묶음 |
| 메뉴 상품 | Menu Product   | 메뉴에 등록된 상품들             |
