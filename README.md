...
| 주문 금액  | order line amount | 주문한 메뉴의 금액.      |
...
| 접수완료   | accepted         | 포장 주문이 접수된 상태.         |
| 픽업완료   | picked up        | 포장 주문이 고객에게 전달 완료된 상태. |
| 포장주문완료 | completed        | 포장 주문이 완료 상태.          |
...
| 접수완료   | accepted     | 매장 주문이 접수된 상태.           |
| 서빙완료   | served       | 매장 주문이 매장 테이블에 서빙완료된 상태. |
| 매장주문완료 | completed    | 매장 주문이 완료 상태.            |
