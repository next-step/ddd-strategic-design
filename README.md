...
| 메뉴 | menu | 메뉴정보 - 메뉴에 적용 할 상품, 가격, 수, 메뉴 그룹의 정보를 포함한다. |
...
| 주문 종류 | order-type | 주문 종류 - 배달 주문, 포장 주문, 매장 주문의 3가지 종류를 갖는다. |
| 주문 상태 | order-status | 주문 상태 - 접수 대기중, 주문 접수, 서빙, 배달, 배달 완료, 주문 완료의 6가지 상태를 갖는다. |
