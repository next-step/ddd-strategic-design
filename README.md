...
| 상품 목록 | product list  | 등록된 `상품`의 목록                 |
...
| 메뉴 그룹명   | menu group name | `메뉴그룹`의 이름                   |
| 메뉴 그룹 목록 | menu group list | 등록된 `메뉴그룹`의 목록               |
...
| 주문 테이블명   | order table name | `테이블`의 이름                        |
