...
| 주문상태 | orderStatus | 주문의 진행상태. <br/> * 접수대기, 접수, 서빙완료, 주문완료로 구분한다.                             |
...
| 주문상태 | orderStatus | 주문의 진행상태. <br/> * 접수대기, 접수, 포장완료, 주문완료로 구분한다.                             |
| 접수대기 | waiting | 등록한 주문의 최초 상태.                                                            |
| 접수 | accepted | 주문을 확인하고, 조리를 시작한 상태.                                                     |
...
| 주문상태 | orderStatus | 주문의 진행상태. <br/> * 접수대기, 접수, 포장완료, 배달중, 배달완료, 주문완료로 구분한다.                         |
| 접수대기 | waiting | 등록한 주문의 최초 상태.                                                                   |
| 접수 | accepted | 주문을 확인하고, 조리를 시작한 상태.                                                            |
| 포장완료 | packed | 조리완료된 음식을 포장한 상태.                                                                |
