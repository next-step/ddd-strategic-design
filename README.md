...
| 메뉴 가격  | price       | 상품들의 총가격 합으로 이루어진 메뉴 금액을 의미합니다.                                              |
...
| 주문 상품       | orderLineItem | 고객이 요청한 메뉴의 상품와 그 수량에 대한 내역을 의미합니다.                                                                |
| 주문 상품 개수    | quantity      | 주문에 포함된 상품의 개수를 의미합니다.                                                                               |
| 주문 상품 금액    | price         | 주문에 포함된 상품의 금액을 의미합니다. ex: 후라이드 치킨 가격이 12000원이고 2개라면 24000원이 됩니다.                                                                                                                           |
...
| 제공된 주문     | servedOrder      | 고객에게 주문 내역에 있는 메뉴를 제공한 상태 <br/>배달 주문의 경우, 배달대행사에게 메뉴를 제공한다<br/> 포장 주문의 경우, 상품이 준비 완료된 상황이다.<br/> 매장 주문의 경우,주문테이블에 있는 고객에게 상품을 제공한다. |                                                                                                                            
| 배달중인 주문    | deliveringOrder  | 배달 주문을 한 고객에게 배달을 시작한 상황                                                                                                            |                                                                                                                                                                 
| 배달 완료된 주문  | deliveredOrder   | 배달 주문을 한 고객에게 배달을 완료한 상황                                                                                                            |                                                                                                                                                                  
| 완료된 주문     | completeOrder    | 주문의 모든 처리가 끝난 상황. 매장 및 포장 주문 : 한 고객에게 주문이 제공된 상황<br/>배달 주문 : 고객에게 배달이 완료된 상황 <br/>위와 같은 상황인 경우, 해당 주문을 주문 완료 상황으로 변경한다              |
