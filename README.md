...
### 메뉴
- 식별자, 이름, 가격, 메뉴 상품을 갖는다.
- 가격은 메뉴 상품 금액의 합 이하 여야 한다.
- 가격이 메뉴 상품 금액의 합보다 크면 비공개가 된다.
- 메뉴 상품은 가격과 수를 갖는다.
- 메뉴 그룹에 속한다.
#### 메뉴 그룹
- 식별자와 이름을 갖는다.
...
### 매장 주문 
- 접수 대기 -> 접수 -> 서빙 -> 계산 완료 순서로 진행된다.
- 식별자, 주문 상태, 주문 시간, 주문 항목들을 갖는다.
- 주문 항목은 가격과 수량을 갖는다.
#### 매장 주문 테이블
- 식별자, 이름, 고객 수를 갖는다.
- 주문이 완료되면 빈 테이블이 된다.
...
### 배달 주문
- 식별자, 주문 상태, 주문 시간, 배달 주소, 주문 항목들을 갖는다.
- 접수 대기 -> 접수 -> 서빙 -> 배달 -> 배달 완료 -> 계산 완료 순서로 진행된다.
- 주문이 접수되면 배달 대행사가 호출된다.
- 주문 항목은 가격과 수량을 갖는다.
- 주문 항목의 수량은 1보다 커야 한다.
