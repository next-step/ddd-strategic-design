package tobe.kitchenpos.order.application.common;
...
import tobe.kitchenpos.order.domain.eatin.EatInOrderRepository;
import tobe.kitchenpos.order.domain.common.OrderTableRepository;
