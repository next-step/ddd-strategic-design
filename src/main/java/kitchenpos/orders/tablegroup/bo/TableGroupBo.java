package kitchenpos.orders.tablegroup.bo;
...
import kitchenpos.orders.tablegroup.dao.TableGroupDao;
...
public class TableGroupBo {
    ...
    public TableGroupBo(final OrderDao orderDao, final OrderTableDao orderTableDao,
