...
import kitchenpos.order.orderEatIn.domain.OrderTableRepository;
...
public class OrderTableService {
    ...
    public OrderTableService(final OrderTableRepository orderTableRepository, final OrderEatInRepository orderRepository) {
