package kitchenpos.menu.application.repository;

import kitchenpos.menu.application.model.MenuProduct;
import kitchenpos.menu.application.model.MenuProductRepository;
...
@Repository
public class JdbcTemplateMenuProductRepository implements MenuProductRepository {
    ...
    public JdbcTemplateMenuProductRepository(final DataSource dataSource) {
