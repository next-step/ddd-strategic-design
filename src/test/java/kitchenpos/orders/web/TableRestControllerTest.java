...
import static kitchenpos.Fixtures.TABLE1_ID;
...
import kitchenpos.orders.domain.usecase.TableBo;
import kitchenpos.orders.domain.entity.OrderTable;
import kitchenpos.orders.web.TableRestController;
...
class TableRestControllerTest {
    ...
    void changeNumberOfGuests() throws Exception {
        // given
        given(tableBo.changeNumberOfGuests(eq(TABLE1_ID), any(OrderTable.class)))
            .willReturn(table1());
