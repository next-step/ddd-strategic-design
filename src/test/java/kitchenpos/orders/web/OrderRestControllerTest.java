...
import kitchenpos.orders.domain.usecase.OrderBo;
import kitchenpos.orders.domain.entity.Order;
import kitchenpos.orders.web.OrderRestController;
...
class OrderRestControllerTest {
    ...
    void changeOrderStatus() throws Exception {
        // given
        given(orderBo.changeOrderStatus(eq(ORDER_FOR_TABLE1_ID), any(Order.class)))
            .willReturn(orderForTable1());
