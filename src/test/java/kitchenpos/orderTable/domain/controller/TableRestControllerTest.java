package kitchenpos.orderTable.domain.controller;

import kitchenpos.orderTable.domain.model.OrderTable;
import kitchenpos.orderTable.application.service.OrderTableService;
import kitchenpos.orderTable.ui.controller.TableRestController;
...
class TableRestControllerTest {
    ...
    void create() throws Exception {
        // given
        given(orderTableService.create(any(OrderTable.class))).willReturn(emptyTable1());
    ...
    void list() throws Exception {
        // given
        given(orderTableService.list()).willReturn(Arrays.asList(groupedTable1(), groupedTable2()));
    ...
    void changeEmpty() throws Exception {
        // given
        given(orderTableService.changeEmpty(eq(TABLE1_ID), any(OrderTable.class))).willReturn(table1());
    ...
    void changeNumberOfGuests() throws Exception {
        // given
        given(orderTableService.changeNumberOfGuests(eq(TABLE1_ID), any(OrderTable.class))).willReturn(table1());
